...
`${GOPATH}/src/github.com/tonyjia87/prometheusrdbeat`
...
```
git remote set-url origin https://github.com/tonyjia87/prometheusrdbeat
...
in the same directory with the name prometheusrdbeat.
...
```
./prometheusrdbeat -c prometheusrdbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/tonyjia87/prometheusrdbeat
git clone https://github.com/tonyjia87/prometheusrdbeat ${GOPATH}/src/github.com/tonyjia87/prometheusrdbeat
```
